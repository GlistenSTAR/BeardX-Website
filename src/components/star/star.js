...
export default function Star() {
  return (
    <svg className='star' viewBox='114.551 81.194 134.814 113.214'>
      <g className='sparkles'>
        <path
          style={{ '--duration': '1.9s', '--delay': '0s' }}
